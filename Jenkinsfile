...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.24.90:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-ajt', //update and provide your Slack channel name
